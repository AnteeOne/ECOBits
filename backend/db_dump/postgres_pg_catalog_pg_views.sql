INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_shadow', 'anteeone', ' SELECT pg_authid.rolname AS usename,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_roles', 'anteeone', ' SELECT pg_authid.rolname,
    pg_authid.rolsuper,
   ...
   FROM (pg_authid
     LEFT JOIN pg_db_role_setting s ON (((pg_authid.oid = s.setrole) AND (s.setdatabase = (0)::oid))));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_settings', 'anteeone', ' SELECT a.name,
    a.setting,
    a.unit,
    a.category,
    a.short_desc,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_file_settings', 'anteeone', ' SELECT a.sourcefile,
    a.sourceline,
    a.seqno,
    a.name,
    a.setting,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_hba_file_rules', 'anteeone', ' SELECT a.line_number,
    a.type,
    a.database,
    a.user_name,
    a.address,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_config', 'anteeone', ' SELECT pg_config.name,
    pg_config.setting
   FROM pg_config() pg_config(name, setting);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_cursors', 'anteeone', ' SELECT c.name,
    c.statement,
    c.is_holdable,
    c.is_binary,
    c.is_scrollable,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_bgwriter', 'anteeone', ' SELECT pg_stat_get_bgwriter_timed_checkpoints() AS checkpoints_timed,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_replication_origin_status', 'anteeone', ' SELECT pg_show_replication_origin_status.local_id,
    pg_show_replication_origin_status.external_id,
    pg_show_replication_origin_status.remote_lsn,
    pg_show_replication_origin_status.local_lsn
   FROM pg_show_replication_origin_status() pg_show_replication_origin_status(local_id, external_id, remote_lsn, local_lsn);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_progress_vacuum', 'anteeone', ' SELECT s.pid,
    s.datid,
    d.datname,
    s.relid,
        CASE s.param1
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_progress_cluster', 'anteeone', ' SELECT s.pid,
    s.datid,
    d.datname,
    s.relid,
        CASE s.param1
   ...
   FROM (pg_stat_get_progress_info(''CLUSTER''::text) s(pid, datid, relid, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20)
     LEFT JOIN pg_database d ON ((s.datid = d.oid)));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_progress_create_index', 'anteeone', ' SELECT s.pid,
    s.datid,
    d.datname,
    s.relid,
   ...
   FROM (pg_stat_get_progress_info(''CREATE INDEX''::text) s(pid, datid, relid, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20)
     LEFT JOIN pg_database d ON ((s.datid = d.oid)));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_user_mappings', 'anteeone', ' SELECT u.oid AS umid,
    s.oid AS srvid,
    s.srvname,
    u.umuser,
        CASE
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_group', 'anteeone', ' SELECT pg_authid.rolname AS groname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_user', 'anteeone', ' SELECT pg_shadow.usename,
    pg_shadow.usesysid,
    ...
    pg_shadow.useconfig
   FROM pg_shadow;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_policies', 'anteeone', ' SELECT n.nspname AS schemaname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_rules', 'anteeone', ' SELECT n.nspname AS schemaname,
    c.relname AS tablename,
    r.rulename,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_views', 'anteeone', ' SELECT n.nspname AS schemaname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_tables', 'anteeone', ' SELECT n.nspname AS schemaname,
    c.relname AS tablename,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_matviews', 'anteeone', ' SELECT n.nspname AS schemaname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_indexes', 'anteeone', ' SELECT n.nspname AS schemaname,
    c.relname AS tablename,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_sequences', 'anteeone', ' SELECT n.nspname AS schemaname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stats', 'anteeone', ' SELECT n.nspname AS schemaname,
    c.relname AS tablename,
    a.attname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stats_ext', 'anteeone', ' SELECT cn.nspname AS schemaname,
    c.relname AS tablename,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_publication_tables', 'anteeone', ' SELECT p.pubname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_locks', 'anteeone', ' SELECT l.locktype,
    l.database,
    l.relation,
    l.page,
    l.tuple,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_available_extensions', 'anteeone', ' SELECT e.name,
    e.default_version,
    x.extversion AS installed_version,
    e.comment
   FROM (pg_available_extensions() e(name, default_version, comment)
     LEFT JOIN pg_extension x ON ((e.name = x.extname)));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_available_extension_versions', 'anteeone', ' SELECT e.name,
    e.version,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_prepared_xacts', 'anteeone', ' SELECT p.transaction,
    p.gid,
    p.prepared,
    u.rolname AS owner,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_prepared_statements', 'anteeone', ' SELECT p.name,
    p.statement,
    p.prepare_time,
    p.parameter_types,
    p.from_sql
   FROM pg_prepared_statement() p(name, statement, prepare_time, parameter_types, from_sql);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_seclabels', 'anteeone', ' SELECT l.objoid,
    l.classoid,
    l.objsubid,
        CASE
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_sys_tables', 'anteeone', ' SELECT pg_statio_all_tables.relid,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_timezone_abbrevs', 'anteeone', ' SELECT pg_timezone_abbrevs.abbrev,
    pg_timezone_abbrevs.utc_offset,
    pg_timezone_abbrevs.is_dst
   FROM pg_timezone_abbrevs() pg_timezone_abbrevs(abbrev, utc_offset, is_dst);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_timezone_names', 'anteeone', ' SELECT pg_timezone_names.name,
    pg_timezone_names.abbrev,
    pg_timezone_names.utc_offset,
    pg_timezone_names.is_dst
   FROM pg_timezone_names() pg_timezone_names(name, abbrev, utc_offset, is_dst);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_user_tables', 'anteeone', ' SELECT pg_statio_all_tables.relid,
    pg_statio_all_tables.schemaname,
    pg_statio_all_tables.relname,
    pg_statio_all_tables.heap_blks_read,
    pg_statio_all_tables.heap_blks_hit,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_all_tables', 'anteeone', ' SELECT c.oid AS relid,
    n.nspname AS schemaname,
    c.relname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_xact_all_tables', 'anteeone', ' SELECT c.oid AS relid,
    n.nspname AS schemaname,
    c.relname,
  ...
  WHERE (c.relkind = ANY (ARRAY[''r''::"char", ''t''::"char", ''m''::"char"]))
  GROUP BY c.oid, n.nspname, c.relname;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_sys_tables', 'anteeone', ' SELECT pg_stat_all_tables.relid,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_xact_sys_tables', 'anteeone', ' SELECT pg_stat_xact_all_tables.relid,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_user_tables', 'anteeone', ' SELECT pg_stat_all_tables.relid,
    pg_stat_all_tables.schemaname,
    pg_stat_all_tables.relname,
    pg_stat_all_tables.seq_scan,
    pg_stat_all_tables.seq_tup_read,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_xact_user_tables', 'anteeone', ' SELECT pg_stat_xact_all_tables.relid,
    pg_stat_xact_all_tables.schemaname,
    pg_stat_xact_all_tables.relname,
    pg_stat_xact_all_tables.seq_scan,
    pg_stat_xact_all_tables.seq_tup_read,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_all_tables', 'anteeone', ' SELECT c.oid AS relid,
    n.nspname AS schemaname,
    c.relname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_all_indexes', 'anteeone', ' SELECT c.oid AS relid,
    i.oid AS indexrelid,
    n.nspname AS schemaname,
    c.relname,
   ...
   FROM (((pg_class c
     ...
     LEFT JOIN pg_namespace n ON ((n.oid = c.relnamespace)))
  WHERE (c.relkind = ANY (ARRAY[''r''::"char", ''t''::"char", ''m''::"char"]));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_sys_indexes', 'anteeone', ' SELECT pg_stat_all_indexes.relid,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_user_indexes', 'anteeone', ' SELECT pg_stat_all_indexes.relid,
    pg_stat_all_indexes.indexrelid,
    pg_stat_all_indexes.schemaname,
    pg_stat_all_indexes.relname,
    pg_stat_all_indexes.indexrelname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_all_indexes', 'anteeone', ' SELECT c.oid AS relid,
    i.oid AS indexrelid,
    n.nspname AS schemaname,
    c.relname,
    i.relname AS indexrelname,
   ...
   FROM (((pg_class c
     ...
     LEFT JOIN pg_namespace n ON ((n.oid = c.relnamespace)))
  WHERE (c.relkind = ANY (ARRAY[''r''::"char", ''t''::"char", ''m''::"char"]));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_sys_indexes', 'anteeone', ' SELECT pg_statio_all_indexes.relid,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_user_indexes', 'anteeone', ' SELECT pg_statio_all_indexes.relid,
    pg_statio_all_indexes.indexrelid,
    pg_statio_all_indexes.schemaname,
    pg_statio_all_indexes.relname,
    pg_statio_all_indexes.indexrelname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_all_sequences', 'anteeone', ' SELECT c.oid AS relid,
    n.nspname AS schemaname,
    c.relname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_sys_sequences', 'anteeone', ' SELECT pg_statio_all_sequences.relid,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_statio_user_sequences', 'anteeone', ' SELECT pg_statio_all_sequences.relid,
    pg_statio_all_sequences.schemaname,
    pg_statio_all_sequences.relname,
    pg_statio_all_sequences.blks_read,
    pg_statio_all_sequences.blks_hit
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_activity', 'anteeone', ' SELECT s.datid,
    d.datname,
    s.pid,
    s.usesysid,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_replication', 'anteeone', ' SELECT s.pid,
    s.usesysid,
    u.rolname AS usename,
    s.application_name,
    s.client_addr,
   ...
   FROM ((pg_stat_get_activity(NULL::integer) s(datid, pid, usesysid, application_name, state, query, wait_event_type, wait_event, xact_start, query_start, backend_start, state_change, client_addr, client_hostname, client_port, backend_xid, backend_xmin, backend_type, ssl, sslversion, sslcipher, sslbits, sslcompression, ssl_client_dn, ssl_client_serial, ssl_issuer_dn, gss_auth, gss_princ, gss_enc)
     ...
     LEFT JOIN pg_authid u ON ((s.usesysid = u.oid)));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_wal_receiver', 'anteeone', ' SELECT s.pid,
    s.status,
    s.receive_start_lsn,
    s.receive_start_tli,
    s.received_lsn,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_subscription', 'anteeone', ' SELECT su.oid AS subid,
    su.subname,
    st.pid,
    st.relid,
    st.received_lsn,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_ssl', 'anteeone', ' SELECT s.pid,
    s.ssl,
   ...
   FROM pg_stat_get_activity(NULL::integer) s(datid, pid, usesysid, application_name, state, query, wait_event_type, wait_event, xact_start, query_start, backend_start, state_change, client_addr, client_hostname, client_port, backend_xid, backend_xmin, backend_type, ssl, sslversion, sslcipher, sslbits, sslcompression, ssl_client_dn, ssl_client_serial, ssl_issuer_dn, gss_auth, gss_princ, gss_enc);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_gssapi', 'anteeone', ' SELECT s.pid,
    s.gss_auth AS gss_authenticated,
    s.gss_princ AS principal,
    s.gss_enc AS encrypted
   FROM pg_stat_get_activity(NULL::integer) s(datid, pid, usesysid, application_name, state, query, wait_event_type, wait_event, xact_start, query_start, backend_start, state_change, client_addr, client_hostname, client_port, backend_xid, backend_xmin, backend_type, ssl, sslversion, sslcipher, sslbits, sslcompression, ssl_client_dn, ssl_client_serial, ssl_issuer_dn, gss_auth, gss_princ, gss_enc);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_replication_slots', 'anteeone', ' SELECT l.slot_name,
    l.plugin,
    l.slot_type,
    l.datoid,
    d.datname AS database,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_database', 'anteeone', ' SELECT d.oid AS datid,
    d.datname,
        CASE
   ...
   FROM ( SELECT 0 AS oid,
        ...
        UNION ALL
         SELECT pg_database.oid,
            pg_database.datname
           FROM pg_database) d;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_database_conflicts', 'anteeone', ' SELECT d.oid AS datid,
    d.datname,
   ...
   FROM pg_database d;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_user_functions', 'anteeone', ' SELECT p.oid AS funcid,
    n.nspname AS schemaname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_xact_user_functions', 'anteeone', ' SELECT p.oid AS funcid,
    n.nspname AS schemaname,
    p.proname AS funcname,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_archiver', 'anteeone', ' SELECT s.archived_count,
    s.last_archived_wal,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'information_schema_catalog_name', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS catalog_name;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'check_constraint_routine_usage', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS constraint_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'applicable_roles', 'anteeone', ' SELECT (a.rolname)::information_schema.sql_identifier AS grantee,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'administrable_role_authorizations', 'anteeone', ' SELECT applicable_roles.grantee,
    applicable_roles.role_name,
    applicable_roles.is_grantable
   FROM information_schema.applicable_roles
  WHERE ((applicable_roles.is_grantable)::text = ''YES''::text);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'collation_character_set_applicability', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS collation_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'attributes', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS udt_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'check_constraints', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS constraint_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'character_sets', 'anteeone', ' SELECT (NULL::name)::information_schema.sql_identifier AS character_set_catalog,
    (NULL::name)::information_schema.sql_identifier AS character_set_schema,
    (getdatabaseencoding())::information_schema.sql_identifier AS character_set_name,
    (
        CASE
 ...
 LIMIT 1;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'collations', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS collation_catalog,
    (nc.nspname)::information_schema.sql_identifier AS collation_schema,
    (c.collname)::information_schema.sql_identifier AS collation_name,
  ...
  WHERE ((c.collnamespace = nc.oid) AND (c.collencoding = ANY (ARRAY[''-1''::integer, ( SELECT pg_database.encoding
           FROM pg_database
          WHERE (pg_database.datname = current_database()))])));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'column_domain_usage', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS domain_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'column_column_usage', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'column_privileges', 'anteeone', ' SELECT (u_grantor.rolname)::information_schema.sql_identifier AS grantor,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'column_udt_usage', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS udt_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'columns', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS table_catalog,
    (nc.nspname)::information_schema.sql_identifier AS table_schema,
    (c.relname)::information_schema.sql_identifier AS table_name,
    (a.attname)::information_schema.sql_identifier AS column_name,
    (a.attnum)::information_schema.cardinal_number AS ordinal_position,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'constraint_column_usage', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'schemata', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS catalog_name,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'constraint_table_usage', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'domain_constraints', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS constraint_catalog,
    (rs.nspname)::information_schema.sql_identifier AS constraint_schema,
    (con.conname)::information_schema.sql_identifier AS constraint_name,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'domain_udt_usage', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS udt_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'sequences', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS sequence_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'domains', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS domain_catalog,
    (nt.nspname)::information_schema.sql_identifier AS domain_schema,
    (t.typname)::information_schema.sql_identifier AS domain_name,
    (
        CASE
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'enabled_roles', 'anteeone', ' SELECT (a.rolname)::information_schema.sql_identifier AS role_name
   FROM pg_authid a
  WHERE pg_has_role(a.oid, ''USAGE''::text);');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'key_column_usage', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS constraint_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'parameters', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS specific_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'referential_constraints', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS constraint_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'role_column_grants', 'anteeone', ' SELECT column_privileges.grantor,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'routine_privileges', 'anteeone', ' SELECT (u_grantor.rolname)::information_schema.sql_identifier AS grantor,
    (grantee.rolname)::information_schema.sql_identifier AS grantee,
    (current_database())::information_schema.sql_identifier AS specific_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'role_routine_grants', 'anteeone', ' SELECT routine_privileges.grantor,
  ...
  WHERE (((routine_privileges.grantor)::name IN ( SELECT enabled_roles.role_name
           ...
           FROM information_schema.enabled_roles)));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'routines', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS specific_catalog,
    (n.nspname)::information_schema.sql_identifier AS specific_schema,
    (nameconcatoid(p.proname, p.oid))::information_schema.sql_identifier AS specific_name,
    (current_database())::information_schema.sql_identifier AS routine_catalog,
    (n.nspname)::information_schema.sql_identifier AS routine_schema,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'table_constraints', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS constraint_catalog,
    (nc.nspname)::information_schema.sql_identifier AS constraint_schema,
    (c.conname)::information_schema.sql_identifier AS constraint_name,
    (current_database())::information_schema.sql_identifier AS table_catalog,
    (nr.nspname)::information_schema.sql_identifier AS table_schema,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'table_privileges', 'anteeone', ' SELECT (u_grantor.rolname)::information_schema.sql_identifier AS grantor,
    (grantee.rolname)::information_schema.sql_identifier AS grantee,
    (current_database())::information_schema.sql_identifier AS table_catalog,
    (nc.nspname)::information_schema.sql_identifier AS table_schema,
    (c.relname)::information_schema.sql_identifier AS table_name,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'role_table_grants', 'anteeone', ' SELECT table_privileges.grantor,
  ...
  WHERE (((table_privileges.grantor)::name IN ( SELECT enabled_roles.role_name
           ...
           FROM information_schema.enabled_roles)));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'views', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS table_catalog,
    (nc.nspname)::information_schema.sql_identifier AS table_schema,
    (c.relname)::information_schema.sql_identifier AS table_name,
    (
        CASE
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'tables', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS table_catalog,
    (nc.nspname)::information_schema.sql_identifier AS table_schema,
    (c.relname)::information_schema.sql_identifier AS table_name,
    (
        CASE
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'transforms', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS udt_catalog,
    (nt.nspname)::information_schema.sql_identifier AS udt_schema,
    (t.typname)::information_schema.sql_identifier AS udt_name,
    (current_database())::information_schema.sql_identifier AS specific_catalog,
    (np.nspname)::information_schema.sql_identifier AS specific_schema,
...
UNION
 SELECT (current_database())::information_schema.sql_identifier AS udt_catalog,
   ...
   FROM (((((pg_type t
     ...
     JOIN pg_namespace np ON ((p.pronamespace = np.oid)))
  ORDER BY 1, 2, 3, 7, 8;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'triggered_update_columns', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS trigger_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', '_pg_foreign_servers', 'anteeone', ' SELECT s.oid,
    s.srvoptions,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'triggers', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS trigger_catalog,
    (n.nspname)::information_schema.sql_identifier AS trigger_schema,
    (t.tgname)::information_schema.sql_identifier AS trigger_name,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'data_type_privileges', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS object_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'udt_privileges', 'anteeone', ' SELECT (u_grantor.rolname)::information_schema.sql_identifier AS grantor,
    (grantee.rolname)::information_schema.sql_identifier AS grantee,
    (current_database())::information_schema.sql_identifier AS udt_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'role_udt_grants', 'anteeone', ' SELECT udt_privileges.grantor,
  ...
  WHERE (((udt_privileges.grantor)::name IN ( SELECT enabled_roles.role_name
           ...
           FROM information_schema.enabled_roles)));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'usage_privileges', 'anteeone', ' SELECT (u.rolname)::information_schema.sql_identifier AS grantor,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'element_types', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS object_catalog,
    (n.nspname)::information_schema.sql_identifier AS object_schema,
    x.objname AS object_name,
    (x.objtype)::information_schema.character_data AS object_type,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'role_usage_grants', 'anteeone', ' SELECT usage_privileges.grantor,
  ...
  WHERE (((usage_privileges.grantor)::name IN ( SELECT enabled_roles.role_name
           ...
           FROM information_schema.enabled_roles)));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'user_defined_types', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS user_defined_type_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', '_pg_foreign_table_columns', 'anteeone', ' SELECT n.nspname,
    c.relname,
    a.attname,
    a.attfdwoptions
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'view_column_usage', 'anteeone', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS view_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'view_routine_usage', 'anteeone', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'view_table_usage', 'anteeone', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS view_catalog,
    (nv.nspname)::information_schema.sql_identifier AS view_schema,
    (v.relname)::information_schema.sql_identifier AS view_name,
    (current_database())::information_schema.sql_identifier AS table_catalog,
    (nt.nspname)::information_schema.sql_identifier AS table_schema,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'foreign_server_options', 'anteeone', ' SELECT s.foreign_server_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'column_options', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', '_pg_foreign_data_wrappers', 'anteeone', ' SELECT w.oid,
    w.fdwowner,
    w.fdwoptions,
    (current_database())::information_schema.sql_identifier AS foreign_data_wrapper_catalog,
    (w.fdwname)::information_schema.sql_identifier AS foreign_data_wrapper_name,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'foreign_data_wrapper_options', 'anteeone', ' SELECT w.foreign_data_wrapper_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'foreign_tables', 'anteeone', ' SELECT _pg_foreign_tables.foreign_table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'foreign_data_wrappers', 'anteeone', ' SELECT w.foreign_data_wrapper_catalog,
    w.foreign_data_wrapper_name,
   ...
   FROM information_schema._pg_foreign_data_wrappers w;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'foreign_servers', 'anteeone', ' SELECT _pg_foreign_servers.foreign_server_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', '_pg_foreign_tables', 'anteeone', ' SELECT (current_database())::information_schema.sql_identifier AS foreign_table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'foreign_table_options', 'anteeone', ' SELECT t.foreign_table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', '_pg_user_mappings', 'anteeone', ' SELECT um.oid,
    um.umoptions,
    um.umuser,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'user_mappings', 'anteeone', ' SELECT _pg_user_mappings.authorization_identifier,
    _pg_user_mappings.foreign_server_catalog,
    _pg_user_mappings.foreign_server_name
   FROM information_schema._pg_user_mappings;');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'user_mapping_options', 'anteeone', ' SELECT um.authorization_identifier,
