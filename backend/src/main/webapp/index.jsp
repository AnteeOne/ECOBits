...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/Navbar---Apple-1.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/Navbar---Apple.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/Parallax-Scroll-Effect.css">
...
<div>
    <div id="box-2">
        <h1>Look at our planet</h1>
    </div>
    <div id="box-3">
        <h1>Only we can save it</h1>
    </div>
    <div id="box-1">
        <h1>Join us to save it</h1>
    </div>
</div>
<div class="footer-basic">
    <footer>
        <p class="copyright">EcoBits © 2020</p>
    </footer>
</div>
